# modified https://raw.githubusercontent.com/Tencent/ncnn/master/python/ncnn/model_zoo/retinaface.py

## Modification
# Added support to use resnet-50 --Accurate face detector instead of mnet only
